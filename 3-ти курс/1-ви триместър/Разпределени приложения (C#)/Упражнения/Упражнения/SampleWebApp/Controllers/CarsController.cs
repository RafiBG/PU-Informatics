...
namespace SampleWebApp.Controllers
{
    public class CarsController : Controller
    {
        ...
        {
            var carDbContext = _context.Cars.Include(c => c.Brand).Include(c => c.Model);
        ...
        public async Task<IActionResult> Create([Bind("Id,vignetteNumber,validityDateFrom,validityDateTo,BrandId,ModelId")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,vignetteNumber,validityDateFrom,validityDateTo,BrandId,ModelId")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
